...
def heart():
    ...
    if st.sidebar.button("GO!"):
        df = input_df.copy()
        st.write(df)
        model = pickle.load(open('Model\general.pkl', 'rb'))
...
if nav == "Home":
    ...
    **Data Cleaning**
    ...
    if var == "Before Tuning":
        ...
        **Kesimpulan**
        ...
        di link berikut ini [Download Model](https://drive.google.com/drive/folders/1qbILX35AMLqY80w2Qyj46UkMlfVbMAos?usp=drive_link).
        ''')
    ...
    **Djeliyana Talaba**
    ...
    saya merupakan seorang sarjana matematika dari salah satu perguruan tinggi di Indonesia yaitu Universitas Tadulako. Saya mengambil jurusan Matematika Murni yang berfokus pada bidang riset dan operasi data. Saya mengikuti kelas Machine 
    Learning & AI di DQLab Academy. Ini adalah capstone project saya.
    ''')
    st.write('''
    **Contact Me**
